...
class EnhancedNavigationEvaluator:
    ...
    def __init__(self):
        ...
        # 参数配置 - 优先从配置文件的evaluator命名空间读取，然后从私有参数读取
        self.robot_name = rospy.get_param('/eskf_navigation_evaluator_9/robot_name', 
                                        rospy.get_param('~robot_name', 'eca_a9'))
        ...
        if filtered_odom_private:
            ...
            filtered_odom_abs = rospy.get_param('/eskf_navigation_evaluator_9/filtered_odom_topic', None)
        ...
        self.file_suffix = rospy.get_param('~file_suffix', 'eval9')
    ...
    def _get_hour_index(self, sim_sec):
    ...
    def evaluate_navigation(self, event):
        ...
        rospy.loginfo("============================================================")
        rospy.loginfo("时间: %s", current_time)
        rospy.loginfo("============================================================")
        rospy.loginfo("ESKF导航系统实时性能评估")
        rospy.loginfo("------------------------------------------------------------")
