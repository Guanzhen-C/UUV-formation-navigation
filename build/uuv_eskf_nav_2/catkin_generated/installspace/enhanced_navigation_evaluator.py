...
class EnhancedNavigationEvaluator:
    ...
    def __init__(self):
        ...
        self.robot_name = rospy.get_param('/eskf_navigation_evaluator_2/robot_name', 
        ...
        if filtered_odom_private:
            ...
            filtered_odom_abs = rospy.get_param('/eskf_navigation_evaluator_2/filtered_odom_topic', None)
        ...
        self.file_suffix = rospy.get_param('~file_suffix', 'eval2')
