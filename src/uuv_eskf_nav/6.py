...
def generate_densest_ring_map():
    ...
    print("Mode: Ultra-Dense Concentric Ripples (Factor=5.0)")
    ...
    # ================= [修改] 7. 极密同心条纹 =================
    # 使用 dist_to_center 生成圆环
    # 参数 5.0 意味着波长约为 2*pi*5 = 31.4 米
    # 相比地图尺寸 1000米，会有约 30 个同心圆环
    z_ridges = 4.0 * np.sin(dist_to_center / 5.0)
