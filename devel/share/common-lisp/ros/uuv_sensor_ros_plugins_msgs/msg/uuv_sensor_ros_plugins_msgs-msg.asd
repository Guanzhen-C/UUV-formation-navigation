...
(defsystem "uuv_sensor_ros_plugins_msgs-msg"
  ...
  :components ((:file "_package")
    (:file "AcousticBroadcastMethod3" :depends-on ("_package_AcousticBroadcastMethod3"))
    (:file "_package_AcousticBroadcastMethod3" :depends-on ("_package"))
    (:file "AcousticRangeOWTT" :depends-on ("_package_AcousticRangeOWTT"))
    (:file "_package_AcousticRangeOWTT" :depends-on ("_package"))
    ...
    (:file "Method3SenderState" :depends-on ("_package_Method3SenderState"))
    (:file "_package_Method3SenderState" :depends-on ("_package"))
