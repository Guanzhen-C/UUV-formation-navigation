...
if(rexrov_fgo_nav_CONFIG_INCLUDED)
  return()
endif()
set(rexrov_fgo_nav_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(rexrov_fgo_nav_SOURCE_PREFIX /home/cgz/catkin_ws/src/rexrov_fgo_nav)
  set(rexrov_fgo_nav_DEVEL_PREFIX /home/cgz/catkin_ws/devel)
  set(rexrov_fgo_nav_INSTALL_PREFIX "")
  set(rexrov_fgo_nav_PREFIX ${rexrov_fgo_nav_DEVEL_PREFIX})
else()
  set(rexrov_fgo_nav_SOURCE_PREFIX "")
  set(rexrov_fgo_nav_DEVEL_PREFIX "")
  set(rexrov_fgo_nav_INSTALL_PREFIX /home/cgz/catkin_ws/install)
  set(rexrov_fgo_nav_PREFIX ${rexrov_fgo_nav_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'rexrov_fgo_nav' is deprecated")
...
set(rexrov_fgo_nav_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/cgz/catkin_ws/src/rexrov_fgo_nav/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(rexrov_fgo_nav_INCLUDE_DIRS "")
  set(_include_dirs "/home/cgz/catkin_ws/src/rexrov_fgo_nav/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND rexrov_fgo_nav_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND rexrov_fgo_nav_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(rexrov_fgo_nav_LIBRARY_DIRS ${lib_path})
      list(APPEND rexrov_fgo_nav_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'rexrov_fgo_nav'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND rexrov_fgo_nav_LIBRARIES ${lib})
    endif()
  endif()
...
set(rexrov_fgo_nav_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${rexrov_fgo_nav_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;geometry_msgs;sensor_msgs;nav_msgs;tf2_ros;pcl_ros")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 rexrov_fgo_nav_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${rexrov_fgo_nav_dep}_FOUND)
      find_package(${rexrov_fgo_nav_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rexrov_fgo_nav_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(rexrov_fgo_nav_INCLUDE_DIRS ${${rexrov_fgo_nav_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(rexrov_fgo_nav_LIBRARIES ${rexrov_fgo_nav_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${rexrov_fgo_nav_dep}_LIBRARIES})
  _list_append_deduplicate(rexrov_fgo_nav_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(rexrov_fgo_nav_LIBRARIES ${rexrov_fgo_nav_LIBRARIES})

  _list_append_unique(rexrov_fgo_nav_LIBRARY_DIRS ${${rexrov_fgo_nav_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(rexrov_fgo_nav_EXPORTED_TARGETS ${${rexrov_fgo_nav_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${rexrov_fgo_nav_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
