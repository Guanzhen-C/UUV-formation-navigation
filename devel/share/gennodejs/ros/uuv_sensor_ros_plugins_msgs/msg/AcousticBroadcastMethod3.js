...
class AcousticBroadcastMethod3 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AcousticBroadcastMethod3(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AcousticBroadcastMethod3(null);
...
module.exports = AcousticBroadcastMethod3;
